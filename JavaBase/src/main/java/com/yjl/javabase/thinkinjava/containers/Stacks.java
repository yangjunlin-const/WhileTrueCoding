package com.yjl.javabase.thinkinjava.containers;//: containers/Stacks.java
// Demonstration of Stack Class.

import java.util.LinkedList;
import java.util.Stack;

import static com.yjl.javabase.thinkinjava.net.mindview.util.Print.print;
import static com.yjl.javabase.thinkinjava.net.mindview.util.Print.printnb;
